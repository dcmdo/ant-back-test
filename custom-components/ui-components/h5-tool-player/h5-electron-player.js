 ...
 */
export default class H5ElectronPlayer extends UIComponent{
    get className(){
                        ...
                        <div className="player-button-container">
                            {
                                this.menuConfig.showFullScreen?
                                    <Button className="player-button" extraClass="icon-font"
                                            onClick={UIComponent.fns.constObject(this,"_full_click",
                                                ()=>{this.fullScreen();}
                                            )}
    ...
    get frame(){
        return UIComponent.fns.constElement(this,"_iframe",(this.statesHasChanged("src")),()=>{
            return <div className="html-container" key="container" style={!this.menuConfig.showToolbar?{
                ...
                <webview ref="iframe" src={this.src} style={{border:'none',width:"100%",height:"100%"}} plugins="true" allowpopups="true"/>
            </div>
        })
    }
    getChildren(){
